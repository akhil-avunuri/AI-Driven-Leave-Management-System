        ...
        (userListData = userListData.map(function (e) {
          return (
            e.id == a &&
              ...
              $("#department-input").select2({ multiple: !0 }),
              $("#department-input").val(e.tags).trigger("change")),
            e
          );
        }));
    });
        ...
        ? (e.preventDefault(),
          ...
          "" === i || "" === s || "" === r || editList
            ? "" !== i &&
              ...
              (editList = !1))
            : ((o = {
                id: document.getElementById("userid-input").value,
                memberImg: a,
                nickname: n,
                userName: i,
                designation: s,
    ...
    e.addEventListener("click", function (e) {
      (editList = !1),
        document
          .getElementById("createContact-form")
          .classList.remove("was-validated"),
        (document.getElementById("newContactModalLabel").innerHTML ="Add Faculty"),
        ...
        $("#department-input").select2({ multiple: !0 }),
        $("#department-input").val("").trigger("change");
    });
  });